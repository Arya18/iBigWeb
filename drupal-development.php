...
<div class="wrapper">    
    ...
    <div class="row">
      <img src="assets/img/banners/Drupal-Development.jpg" class="img-responsive" alt="Responsive image">
    </div>
  </div>
    <!--=== End Slider ===-->
    ...
    <div class="container content">
        ...
        <div class="row content-boxes-v2 margin-bottom-30">
            ...
            <div class="col-md-4 md-margin-bottom-30">
                ...
                <p class="text-justify">An investment in Sparx IT Solution’s design and markup services is a way for sustaining business growth by availing the benefits from the best technological resources. We are backed by the expert technocrats to build high-quality web apps.</p>
            </div>
            <div class="col-md-4">
                <h2 class="heading-sm">
                    <a class="link-bg-icon" href="#">
